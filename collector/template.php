...
abstract class Unit {
	...
	public function prepareVariables(\citron\Collector $c): void {
		$b_cfg = \citron\Config::get();
...
//		$cfg = \citron\Config::get();
	...
	public function createComponent(\citron\Collector $c, array $component): bool {
	...
	public static function repeatComponent(\citron\Collector $c, array $component): bool {
